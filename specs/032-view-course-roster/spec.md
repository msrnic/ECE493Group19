# Feature Specification: View list of students enrolled in my course offerings (UC-32)

**Feature Branch**: `032-view-course-roster`  
**Created**: 2026-03-14  
**Status**: Draft  
**Input**: User description: "UC-32"
...
- Q: How should use-case traceability be enforced? -> A: Every story and requirement maps to `Use Cases/UC-32.md` and `Acceptance Tests/UC-32-AS.md`.
...
Professor views enrolled students for course offerings they teach, with authorization checks and complete roster details.

**Why this priority**: This is the core user value and minimum viable delivery.

**Independent Test**: Execute the primary flow acceptance cases from `Acceptance Tests/UC-32-AS.md`.
...
Source mapping: `Use Cases/UC-32.md`, `Acceptance Tests/UC-32-AS.md`.
...
**Independent Test**: Execute alternate flow acceptance cases from `Acceptance Tests/UC-32-AS.md`.
...
Source mapping: `Use Cases/UC-32.md` extensions, `Acceptance Tests/UC-32-AS.md`.
...
**Independent Test**: Execute fault/error acceptance cases from `Acceptance Tests/UC-32-AS.md`.
...
- Scope remains aligned to `UC-32` and `UC-32-AS` as requirements evolve.

## Requirements *(mandatory)*

### Functional Requirements

- **FR-001**: System MUST implement the main success scenario in `Use Cases/UC-32.md`.
- **FR-002**: System MUST support extension/alternate paths defined in `Use Cases/UC-32.md`.
- **FR-003**: System MUST preserve failed-end-condition consistency guarantees from `Use Cases/UC-32.md`.
...
- **FR-005**: System MUST maintain role-based access behavior for the `Professor` actor.
...
- **SC-001**: 100% of main success scenarios in `UC-32-AS` pass with no unauthorized side effects.
- **SC-002**: 100% of extension scenarios in `UC-32-AS` return defined alternate outcomes.
- **SC-003**: 100% of error/failure scenarios in `UC-32-AS` preserve prior consistent state.
- **SC-004**: Professors can open roster details for an assigned offering within 2 seconds for standard requests.
