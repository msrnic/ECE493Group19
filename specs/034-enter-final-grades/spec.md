# Feature Specification: Enter final grades for students (UC-34)

**Feature Branch**: `034-enter-final-grades`  
**Created**: 2026-03-14  
**Status**: Draft  
...
- Q: How should use-case traceability be enforced? -> A: Every story and requirement maps to `Use Cases/UC-34.md` and `Acceptance Tests/UC-34-AS.md`.
...
Professor enters final grades for enrolled students in assigned offerings, and valid entries are recorded.

**Why this priority**: This is the core user value and minimum viable delivery.

**Independent Test**: Execute the primary flow acceptance cases from `Acceptance Tests/UC-34-AS.md`.
...
Source mapping: `Use Cases/UC-34.md`, `Acceptance Tests/UC-34-AS.md`.
...
**Independent Test**: Execute alternate flow acceptance cases from `Acceptance Tests/UC-34-AS.md`.
...
Source mapping: `Use Cases/UC-34.md` extensions, `Acceptance Tests/UC-34-AS.md`.
...
**Independent Test**: Execute fault/error acceptance cases from `Acceptance Tests/UC-34-AS.md`.
...
- Scope remains aligned to `UC-34` and `UC-34-AS` as requirements evolve.

## Requirements *(mandatory)*

### Functional Requirements

- **FR-001**: System MUST implement the main success scenario in `Use Cases/UC-34.md`.
- **FR-002**: System MUST support extension/alternate paths defined in `Use Cases/UC-34.md`.
- **FR-003**: System MUST preserve failed-end-condition consistency guarantees from `Use Cases/UC-34.md`.
...
- **SC-001**: 100% of main success scenarios in `UC-34-AS` pass with no unauthorized side effects.
- **SC-002**: 100% of extension scenarios in `UC-34-AS` return defined alternate outcomes.
- **SC-003**: 100% of error/failure scenarios in `UC-34-AS` preserve prior consistent state.
- **SC-004**: Professors receive grade-entry validation and persistence confirmation within 2 seconds for standard requests.
