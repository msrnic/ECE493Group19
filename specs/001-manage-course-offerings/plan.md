...
**Branch**: `001-manage-course-offerings` | **Date**: 2026-03-09 | **Spec**: [/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/spec.md](/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/spec.md)
**Input**: Feature specification from `/specs/001-manage-course-offerings/spec.md`
...
```text
specs/001-manage-course-offerings/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
...
Research output is recorded in `/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/research.md` and resolves all initial technical decisions:
...
1. Data model in `/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/data-model.md`.
2. REST API contract in `/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/contracts/openapi.yaml`.
3. Validation and manual test workflow in `/home/m_srnic/ece493/group_project/ECE493Group19/specs/001-manage-course-offerings/quickstart.md`.
