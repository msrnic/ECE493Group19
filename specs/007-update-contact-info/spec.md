...
**Feature Branch**: `007-update-contact-info`  
**Created**: 2026-03-06  
**Status**: Draft  
...
- Email/phone/address format validation MUST follow `specs/007-update-contact-info/contracts/contact-info-api.md` and `specs/007-update-contact-info/research.md`.
