# Feature Specification: Update final grades before submission deadline (UC-35)

**Feature Branch**: `035-update-grades-deadline`  
**Created**: 2026-03-14  
**Status**: Draft  
...
- Q: How should use-case traceability be enforced? -> A: Every story and requirement maps to `Use Cases/UC-35.md` and `Acceptance Tests/UC-35-AS.md`.
...
Professor updates previously entered final grades before deadline and changes are persisted in records.

**Why this priority**: This is the core user value and minimum viable delivery.

**Independent Test**: Execute the primary flow acceptance cases from `Acceptance Tests/UC-35-AS.md`.
...
Source mapping: `Use Cases/UC-35.md`, `Acceptance Tests/UC-35-AS.md`.
...
**Independent Test**: Execute alternate flow acceptance cases from `Acceptance Tests/UC-35-AS.md`.
...
Source mapping: `Use Cases/UC-35.md` extensions, `Acceptance Tests/UC-35-AS.md`.
...
**Independent Test**: Execute fault/error acceptance cases from `Acceptance Tests/UC-35-AS.md`.
...
- Scope remains aligned to `UC-35` and `UC-35-AS` as requirements evolve.

## Requirements *(mandatory)*

### Functional Requirements

- **FR-001**: System MUST implement the main success scenario in `Use Cases/UC-35.md`.
- **FR-002**: System MUST support extension/alternate paths defined in `Use Cases/UC-35.md`.
- **FR-003**: System MUST preserve failed-end-condition consistency guarantees from `Use Cases/UC-35.md`.
...
- **SC-001**: 100% of main success scenarios in `UC-35-AS` pass with no unauthorized side effects.
- **SC-002**: 100% of extension scenarios in `UC-35-AS` return defined alternate outcomes.
- **SC-003**: 100% of error/failure scenarios in `UC-35-AS` preserve prior consistent state.
- **SC-004**: Professors receive update confirmation or deadline-block guidance within 2 seconds for standard requests.
