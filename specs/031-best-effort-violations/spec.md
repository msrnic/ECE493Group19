# Feature Specification: Show violated constraints in best-effort schedules (UC-31)

**Feature Branch**: `031-best-effort-violations`  
**Created**: 2026-03-14  
**Status**: Draft  
...
- Q: How should use-case traceability be enforced? -> A: Every story and requirement maps to `Use Cases/UC-31.md` and `Acceptance Tests/UC-31-AS.md`.
...
Student inspects best-effort schedules and sees exactly which constraints were violated and how.

**Why this priority**: This is the core user value and minimum viable delivery.

**Independent Test**: Execute the primary flow acceptance cases from `Acceptance Tests/UC-31-AS.md`.
...
Source mapping: `Use Cases/UC-31.md`, `Acceptance Tests/UC-31-AS.md`.
...
**Independent Test**: Execute alternate flow acceptance cases from `Acceptance Tests/UC-31-AS.md`.
...
Source mapping: `Use Cases/UC-31.md` extensions, `Acceptance Tests/UC-31-AS.md`.
...
**Independent Test**: Execute fault/error acceptance cases from `Acceptance Tests/UC-31-AS.md`.
...
- Scope remains aligned to `UC-31` and `UC-31-AS` as requirements evolve.

## Requirements *(mandatory)*

### Functional Requirements

- **FR-001**: System MUST implement the main success scenario in `Use Cases/UC-31.md`.
- **FR-002**: System MUST support extension/alternate paths defined in `Use Cases/UC-31.md`.
- **FR-003**: System MUST preserve failed-end-condition consistency guarantees from `Use Cases/UC-31.md`.
...
- **SC-001**: 100% of main success scenarios in `UC-31-AS` pass with no unauthorized side effects.
- **SC-002**: 100% of extension scenarios in `UC-31-AS` return defined alternate outcomes.
- **SC-003**: 100% of error/failure scenarios in `UC-31-AS` preserve prior consistent state.
- **SC-004**: Students can open violation details and identify each violated constraint within 2 seconds for standard requests.
