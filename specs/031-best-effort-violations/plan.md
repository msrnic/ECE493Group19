# Implementation Plan: Show violated constraints in best-effort schedules (UC-31)

**Branch**: `031-best-effort-violations` | **Date**: 2026-03-14 | **Spec**:
[/Users/ahsanmansoor/ECE493Group19/specs/031-best-effort-violations/spec.md](/Users/ahsanmansoor/ECE493Group19/specs/031-best-effort-violations/spec.md)
**Input**: Feature specification from `/specs/031-best-effort-violations/spec.md`

## Summary

Implement Show violated constraints in best-effort schedules (UC-31) with full UC-to-AS traceability, MVC boundaries, and SQLite-backed persistence where applicable. Include explicit alternate/error handling so failures do not mutate protected state.
...
**Testing**: Acceptance execution from `Acceptance Tests/UC-31-AS.md`, plus targeted unit/integration tests  
...
**Scale/Scope**: Single use-case feature mapped to `UC-31` and `UC-31-AS`
...
```text
specs/031-best-effort-violations/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
