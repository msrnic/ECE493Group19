# Use Case UC-06: View my contact information,

**Goal in Context**: view my contact information,.
**Scope**: University Student Information System (Enrollment, Fees, Grades, Notifications)
**Level**: User Goal
**Primary Actor**: Registered User
**Secondary Actors**: Database
**Trigger**: Registered User selects 'View my contact information,' in the application.
