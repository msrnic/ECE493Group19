# Use Case UC-08: View enrollment capacity and remaining seats for my courses,

**Goal in Context**: view enrollment capacity and remaining seats for my courses,.
...
**Trigger**: Registered User selects 'View enrollment capacity and remaining seats for my courses,' in the application.
